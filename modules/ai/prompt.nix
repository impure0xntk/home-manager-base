...
let
  ...
  mcp = {
    usage = ''
      - WebSearch
        - devtools MCP to search summaries and URLs -> playwright MCP or devtools MCP to fetch and read the page
        - For any information fetched or researched from the web, you must provide the sources at the end of the output
